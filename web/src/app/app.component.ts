    ...
    ngOnInit() {
        this.items = [
            ...
            { label: 'Entities', icon: 'fa-search', items: [
                    ...
                    {label: 'Databasechangelog Create', routerLink: ['/databasechangelog/new']},
                    {label: 'Databasechangeloglock Search', routerLink: ['/databasechangeloglock-list']},
                    {label: 'Databasechangeloglock Create', routerLink: ['/databasechangeloglock/new']},
                    {label: 'Enquiry Search', routerLink: ['/enquiry-list']},
                    {label: 'Enquiry Create', routerLink: ['/enquiry/new']},
                    {label: 'Goods Search', routerLink: ['/goods-list']},
                    ...
                    {label: 'Rate Create', routerLink: ['/rate/new']},
                    {label: 'Record Search', routerLink: ['/record-list']},
                    {label: 'Record Create', routerLink: ['/record/new']},
                    ...
                    {label: 'Warehouse Search', routerLink: ['/warehouse-list']},
                    {label: 'Warehouse Create', routerLink: ['/warehouse/new']},
                    {label: 'WarehousePhoto Search', routerLink: ['/warehousePhoto-list']},
                    {label: 'WarehousePhoto Create', routerLink: ['/warehousePhoto/new']},
                    {label: 'WarehouseReview Search', routerLink: ['/warehouseReview-list']},
                    {label: 'WarehouseReview Create', routerLink: ['/warehouseReview/new']},
                    {label: 'WarehouseServiceProvider Search', routerLink: ['/warehouseServiceProvider-list']},
                    {label: 'WarehouseServiceProvider Create', routerLink: ['/warehouseServiceProvider/new']}                ]
            },
