...
export class OrderListComponent {
    ...
    // list is paginated
    currentPage : PageResponse<Order> = new PageResponse<Order>(0,0,[]);
    ...
    loadPage(event : LazyLoadEvent) {
        this.orderService.getPage(this.example, event).
            subscribe(
    ...
    showDeleteDialog(rowData : any) {
        let orderToDelete : Order = <Order> rowData;
    ...
    private delete(orderToDelete : Order) {
        let id =  orderToDelete.id;

        this.orderService.delete(id).
            subscribe(
                response => {
                    this.currentPage.remove(orderToDelete);
