...
@Entity
@Table(name = "bookmark")
public class Bookmark implements Identifiable<Integer>, Serializable {
    ...
    public Bookmark creationDate(Instant creationDate) {
    ...
    public Bookmark creationAuthor(String creationAuthor) {
    ...
    public Bookmark lastModificationDate(Instant lastModificationDate) {
    ...
    public Bookmark lastModificationAuthor(String lastModificationAuthor) {
    ...
    public Bookmark version(Integer version) {
        setVersion(version);
        return this;
    }
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    // many-to-one: Bookmark.user ==> User.id
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    /**
     * Set the {@link #user} without adding this Bookmark instance on the passed {@link #user}
     */
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    // many-to-one: Bookmark.warehouse ==> Warehouse.id
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    /**
     * Set the {@link #warehouse} without adding this Bookmark instance on the passed {@link #warehouse}
     */
    public void setWarehouse(Warehouse warehouse) {
        this.warehouse = warehouse;
    }

    public Bookmark warehouse(Warehouse warehouse) {
    ...
    public boolean equals(Object other) {
        return this == other || (other instanceof Bookmark && hashCode() == other.hashCode());
    }
    ...
    /**
     * Construct a readable string representation for this Bookmark instance.
